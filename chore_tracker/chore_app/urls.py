...
urlpatterns = [
	...
	url('house/(?P<house_id>[0-9]+)/home/$', views.index, name='index'),
	url(r'^house/(?P<house_id>[0-9]+)/housemate/(?P<housemate_id>[0-9]+)/chore-summary$', views.detail, name='detail'),
	url(r'^house/(?P<house_id>[0-9]+)/housemate/(?P<housemate_id>[0-9]+)/add_chore$', views.addChore, name='addChore'),
	url(r'^house/(?P<house_id>[0-9]+)/home/add_housemate$', views.addHousemate, name='addHousemate'),
